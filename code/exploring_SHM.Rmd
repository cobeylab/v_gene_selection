...
count_mutations_above_threshold_by_clone <- function(clone_freqs, mutation_freqs_within_clones,
  ...
  all_productive_clones <- clone_freqs %>%
    select(mouse_id, group_controls_pooled, infection_status, clone_id, matches('compartment_tissue'),
           matches('compartment_cell_type'), n_clone_seqs_in_compartment)
  
  grouping_vars <- c('mouse_id', 'group_controls_pooled', 'infection_status', 'clone_id')
...
get_distribution_n_mutations_above_threshold <- function(mutations_above_threshold_by_clone,
  ...
  grouping_vars <- c('mutation_freq_threshold', 'mouse_id', 'group_controls_pooled', 'infection_status',
                     'n_mutations_above_threshold')
...
mean_n_mutations_above_threshold_by_compartment %>%
