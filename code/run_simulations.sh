...
do
    sbatch_file_id=$(basename $scenario_dir)_indiviual_$ind
    ...
    echo Rscript simulation_run.R $path_to_allele_info $path_to_model_parameters $ind '${SLURM_ARRAY_TASK_ID}' >> $sbatch_file
